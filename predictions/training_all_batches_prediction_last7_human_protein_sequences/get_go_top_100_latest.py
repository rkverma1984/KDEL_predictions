...
output:
    all_top_100.xlsx, containing top scored sequences from n iterations, with all the relevant data.
    all_bottom_100.xlsx, containing top scored sequences from n iterations, with all the relevant data.
...
# output file names
out_excel_name_top = 'all_top_100.xlsx'
out_excel_name_top_unique = 'all_top_100_unique.xlsx'
out_excel_name_bottom = 'all_bottom_100.xlsx'
out_excel_name_bottom_unique = 'all_bottom_100_unique.xlsx'

# input exp and predicted data
df_exp = pd.read_pickle('../../raw_data/full_dataset_200_exp.df')
...
df_mass_spec = pd.read_excel("Copy of Harvey Lab Mass Spec(2).xlsx")
