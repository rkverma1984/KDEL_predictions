...
checkpoint_store_dir = home_dir + "/PycharmProjects/kdel/stored_checkpoints/all_batches_199seq/" # store checkpoints in this directory
...
output_df = "full_dataset_199_exp.df"  # file name for the processed output dataframe
